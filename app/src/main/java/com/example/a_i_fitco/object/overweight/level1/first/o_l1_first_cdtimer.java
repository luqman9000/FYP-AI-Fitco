...
import static com.example.a_i_fitco.stopwatcher.swstart2;
...
public class o_l1_first_cdtimer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ol1_first_cdtimer);
        ...
        button.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                ...
                Intent intent = new Intent(view.getContext(), second_ov.class);
    ...
    public void onBackPressed() {
        ...
        dialog.setButton(DialogInterface.BUTTON_POSITIVE,"Yes", new DialogInterface.OnClickListener(){
            ...
            public void onClick(DialogInterface dialog, int which) {
                Intent intent = new Intent(o_l1_first_cdtimer.this, MainMenuActivity.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                o_l1_first_cdtimer.this.startActivity(intent);
            }
        });
