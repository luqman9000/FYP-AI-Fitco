...
package com.example.a_i_fitco.object.psquatonly.classification;
...
import com.example.a_i_fitco.finished_easy;
 ...
 */
public class SposeClassifierProcessor {
  Context mContext;
  private static final String TAG = "PoseClassifierProcessor";
  private static final String POSE_SAMPLES_FILE = "pose/squat_pose_samples.csv";
  ...
  @WorkerThread
  public SposeClassifierProcessor(Context context, boolean isStreamMode) {
  ...
  public List<String> getPoseResult(Pose pose, Context context) {
    Intent intent = new Intent(context, finished_easy.class);
