package com.example.a_i_fitco.object.underweight.level1.fourth.classification;
...
import com.example.a_i_fitco.object.underweight.level1.fourth.u_l1_fourth_cdtimer;
...
public class fourthunclassifier {
    ...
    @WorkerThread
    public fourthunclassifier(Context context, boolean isStreamMode) {
    ...
    public List<String> getPoseResult(Pose pose, Context context) {
        ...
        Intent intent = new Intent(context, u_l1_fourth_cdtimer.class);
