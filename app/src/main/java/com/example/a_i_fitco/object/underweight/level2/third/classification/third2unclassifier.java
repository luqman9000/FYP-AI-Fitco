package com.example.a_i_fitco.object.underweight.level2.third.classification;
...
import com.example.a_i_fitco.object.underweight.level2.third.u_l2_third_cdtimer;
...
public class third2unclassifier {
    ...
    @WorkerThread
    public third2unclassifier(Context context, boolean isStreamMode) {
    ...
    public List<String> getPoseResult(Pose pose, Context context) {
        ...
        Intent intent = new Intent(context, u_l2_third_cdtimer.class);
