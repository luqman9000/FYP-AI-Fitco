...
public class u_l2_first_cdtimer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ul2_first_cdtimer);
        ...
        button.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                ...
                Intent intent = new Intent(view.getContext(), second2_un.class);
    ...
    public void onBackPressed() {
        ...
        dialog.setButton(DialogInterface.BUTTON_POSITIVE,"Yes", new DialogInterface.OnClickListener(){
            ...
            public void onClick(DialogInterface dialog, int which) {
                Intent intent = new Intent(u_l2_first_cdtimer.this, MainMenuActivity.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                u_l2_first_cdtimer.this.startActivity(intent);
            }
        });
