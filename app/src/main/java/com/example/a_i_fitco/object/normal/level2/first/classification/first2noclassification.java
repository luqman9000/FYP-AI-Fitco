package com.example.a_i_fitco.object.normal.level2.first.classification;
...
import com.example.a_i_fitco.object.normal.level2.first.n_l2_first_cdtimer;
...
public class first2noclassification{
    ...
    @WorkerThread
    public first2noclassification(Context context, boolean isStreamMode) {
    ...
    public List<String> getPoseResult(Pose pose, Context context) {
        ...
        Intent intent = new Intent(context, n_l2_first_cdtimer.class);
