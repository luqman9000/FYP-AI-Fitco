package com.example.a_i_fitco.object.overweight.level2.first.classification;
...
public class first2classifier {
    ...
    @WorkerThread
    public first2classifier(Context context, boolean isStreamMode) {
    ...
    public List<String> getPoseResult(Pose pose, Context context) {
        ...
        Intent intent = new Intent(context, o_l2_first_cdtimer.class);
