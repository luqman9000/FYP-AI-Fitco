package com.example.a_i_fitco.object.normal.level1.third.classification;
...
import com.example.a_i_fitco.object.normal.level1.third.n_l1_third_cdtimer;
...
public class thirdnoclassification {
    ...
    @WorkerThread
    public thirdnoclassification(Context context, boolean isStreamMode) {
    ...
    public List<String> getPoseResult(Pose pose, Context context) {
        ...
        Intent intent = new Intent(context, n_l1_third_cdtimer.class);
