package com.example.a_i_fitco.object.overweight.level1.first.classification;
...
public class firstclassifier {
    ...
    @WorkerThread
    public firstclassifier(Context context, boolean isStreamMode) {
    ...
    public List<String> getPoseResult(Pose pose, Context context) {
        ...
        Intent intent = new Intent(context, o_l1_first_cdtimer.class);
