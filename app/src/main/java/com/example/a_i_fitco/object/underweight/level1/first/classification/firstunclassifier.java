package com.example.a_i_fitco.object.underweight.level1.first.classification;
...
import com.example.a_i_fitco.object.underweight.level1.first.u_l1_first_cdtimer;
...
public class firstunclassifier {
    ...
    @WorkerThread
    public firstunclassifier(Context context, boolean isStreamMode) {
    ...
    public List<String> getPoseResult(Pose pose, Context context) {
        ...
        Intent intent = new Intent(context, u_l1_first_cdtimer.class);
