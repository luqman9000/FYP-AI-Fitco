package com.example.a_i_fitco.object.normal.level2.second.classification;
...
import com.example.a_i_fitco.object.normal.level2.second.n_l2_second_cdtimer;
...
public class second2noclassification {
    //timer tmClass=new timer();
    private static final String TAG = "PoseClassifierProcessor";
    private static final String POSE_SAMPLES_FILE = "pose/situp_poses_csvs_out.csv";
    //String getTimerStop = stopwatcher.getMinitStop();
    public int repsAfter;
    // Specify classes for which we want rep counting.
    // These are the labels in the given {@code POSE_SAMPLES_FILE}. You can set your own class labels
    // for your pose samples.
    private static final String SIT_CLASS = "up";
    ...
    @WorkerThread
    public second2noclassification(Context context, boolean isStreamMode) {
    ...
    public List<String> getPoseResult(Pose pose, Context context) {
        ...
        Intent intent = new Intent(context, n_l2_second_cdtimer.class);
        ...
        if (!pose.getAllPoseLandmarks().isEmpty()) {
            String maxConfidenceClassResult = "Pose Detected! Do 10 Sit Ups!";
