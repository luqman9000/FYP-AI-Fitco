package com.example.a_i_fitco.object.underweight.level2.first.classification;
...
import com.example.a_i_fitco.object.underweight.level2.first.u_l2_first_cdtimer;
...
public class first2unclassifier {
    ...
    @WorkerThread
    public first2unclassifier(Context context, boolean isStreamMode) {
    ...
    public List<String> getPoseResult(Pose pose, Context context) {
        ...
        Intent intent = new Intent(context, u_l2_first_cdtimer.class);
