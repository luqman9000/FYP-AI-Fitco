package com.example.a_i_fitco.object.overweight.level1.third.classification;
...
import com.example.a_i_fitco.object.overweight.level1.third.o_l1_third_cdtimer;
...
public class thirdclassifier {//timer tmClass=new timer();
    ...
    @WorkerThread
    public thirdclassifier(Context context, boolean isStreamMode) {
    ...
    public List<String> getPoseResult(Pose pose, Context context) {
        ...
        Intent intent = new Intent(context, o_l1_third_cdtimer.class);
