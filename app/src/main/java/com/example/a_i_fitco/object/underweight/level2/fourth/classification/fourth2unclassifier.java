package com.example.a_i_fitco.object.underweight.level2.fourth.classification;
...
public class fourth2unclassifier {
    ...
    @WorkerThread
    public fourth2unclassifier(Context context, boolean isStreamMode) {
    ...
    public List<String> getPoseResult(Pose pose, Context context) {
        ...
        Intent intent = new Intent(context, u_l2_fourth_cdtimer.class);
