...
public class normal_level2_report extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_normal_level2_report);
        TextView durasi = findViewById(R.id.no2textView5);
        TextView kalori = findViewById(R.id.no2textView7);
        ...
        double situpsMET = 8*3.5;

        String weight_value = DB.checkweight(username_value);
        float weighto = Float.parseFloat(weight_value);
        double calories = (((getMinutew1+getMinutew2)*(situpsMET))+((getMinutew3+getMinutew4+getMinutew5)*(burpeesMET)))*(weighto/200);
        ...
        String workout = "10x2 Sit Ups & 10x3 Burpees";
        ...
        Button btn = (Button)findViewById(R.id.no2plist);
        Button btn1 = (Button)findViewById(R.id.nol2_finish);
            ...
            public void onClick(View view){
                ...
                alert.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        startActivity(new Intent(normal_level2_report.this, MainMenuActivity.class));
