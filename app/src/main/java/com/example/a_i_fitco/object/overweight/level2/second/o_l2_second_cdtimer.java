...
import com.example.a_i_fitco.object.overweight.level2.third.third2_ov;
import com.example.a_i_fitco.stopwatcher;

public class o_l2_second_cdtimer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ol2_second_cdtimer);

        TextView textView = (TextView) findViewById(R.id.ol2ftextView);
        Button button = (Button) findViewById(R.id.ol2spbutton);
        ...
        button.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                ...
                Intent intent = new Intent(view.getContext(), third2_ov.class);
    ...
    public void onBackPressed() {
        ...
        dialog.setButton(DialogInterface.BUTTON_POSITIVE,"Yes", new DialogInterface.OnClickListener(){
            ...
            public void onClick(DialogInterface dialog, int which) {
                Intent intent = new Intent(o_l2_second_cdtimer.this, MainMenuActivity.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                o_l2_second_cdtimer.this.startActivity(intent);
            }
        });
