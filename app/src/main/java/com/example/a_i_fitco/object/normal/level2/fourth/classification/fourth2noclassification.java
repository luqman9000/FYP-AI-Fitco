package com.example.a_i_fitco.object.normal.level2.fourth.classification;
...
import com.example.a_i_fitco.object.normal.level2.fourth.n_l2_fourth_cdtimer;
...
public class fourth2noclassification{
    ...
    @WorkerThread
    public fourth2noclassification(Context context, boolean isStreamMode) {
    ...
    public List<String> getPoseResult(Pose pose, Context context) {
        ...
        Intent intent = new Intent(context, n_l2_fourth_cdtimer.class);
