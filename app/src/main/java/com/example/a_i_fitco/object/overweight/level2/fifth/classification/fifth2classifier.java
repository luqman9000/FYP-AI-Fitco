package com.example.a_i_fitco.object.overweight.level2.fifth.classification;
...
import com.example.a_i_fitco.object.overweight.level2.overweight_level2_report;
...
public class fifth2classifier {
    ...
    @WorkerThread
    public fifth2classifier(Context context, boolean isStreamMode) {
    ...
    public List<String> getPoseResult(Pose pose, Context context) {
        ...
        Intent intent = new Intent(context, overweight_level2_report.class);
