package com.example.a_i_fitco.object.overweight.level2.third.classification;
...
import com.example.a_i_fitco.object.overweight.level2.first.o_l2_first_cdtimer;
import com.example.a_i_fitco.object.overweight.level2.third.o_l2_third_cdtimer;
...
public class third2classifier {
    private static final String TAG = "PoseClassifierProcessor";
    private static final String POSE_SAMPLES_FILE = "pose/jumping_jack_out.csv";
    //String getTimerStop = stopwatcher.getMinitStop();
    public int repsAfter;
    // Specify classes for which we want rep counting.
    // These are the labels in the given {@code POSE_SAMPLES_FILE}. You can set your own class labels
    // for your pose samples.
    private static final String SIT_CLASS = "jumping_jack_up";
    ...
    @WorkerThread
    public third2classifier(Context context, boolean isStreamMode) {
    ...
    public List<String> getPoseResult(Pose pose, Context context) {
        ...
        Intent intent = new Intent(context, o_l2_third_cdtimer.class);
        ...
        if (!pose.getAllPoseLandmarks().isEmpty()) {
            String maxConfidenceClassResult = "Pose Detected! Do 10 Jumping Jacks!";
