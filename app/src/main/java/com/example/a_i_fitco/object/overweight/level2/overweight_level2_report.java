package com.example.a_i_fitco.object.overweight.level2;
...
import com.example.a_i_fitco.object.overweight.level1.overweight_level1_report;
import com.example.a_i_fitco.stopwatcher;

public class overweight_level2_report extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_overweight_level2_report);
        TextView durasi = findViewById(R.id.ov2textView5);
        TextView kalori = findViewById(R.id.ov2textView7);
        ...
        double jumpingjacksMET = 8*3.5;

        String weight_value = DB.checkweight(username_value);
        float weighto = Float.parseFloat(weight_value);
        double calories = (((getMinutew1+getMinutew2+getMinutew3)*(jumpingjacksMET))+((getMinutew4+getMinutew5)*(burpeesMET)))*(weighto/200);
        ...
        btn1.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                ...
                alert.setTitle("Do you want to continue the same exercise next time?");
                alert.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        DB.updatestatus(username_value, "2");
                        startActivity(new Intent(overweight_level2_report.this, MainMenuActivity.class));
                ...
                alert.setNegativeButton("No", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        DB.updatestatus(username_value, "1");
                        startActivity(new Intent(overweight_level2_report.this, MainMenuActivity.class));
