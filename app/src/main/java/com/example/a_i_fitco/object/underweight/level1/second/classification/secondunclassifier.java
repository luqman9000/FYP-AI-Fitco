package com.example.a_i_fitco.object.underweight.level1.second.classification;
...
import com.example.a_i_fitco.object.underweight.level1.fourth.fourthunprocessor;
import com.example.a_i_fitco.object.underweight.level1.second.u_l1_second_cdtimer;
...
public class secondunclassifier{
    ...
    private static final String SIT_CLASS = "pushups_down";
    ...
    @WorkerThread
    public secondunclassifier(Context context, boolean isStreamMode) {
    ...
    public List<String> getPoseResult(Pose pose, Context context) {
        ...
        Intent intent = new Intent(context, u_l1_second_cdtimer.class);
        ...
        if (!pose.getAllPoseLandmarks().isEmpty()) {
            String maxConfidenceClassResult = "Pose Detected! Do 10 Push Ups!";
