package com.example.a_i_fitco.object.normal.level2.third.classification;
...
import com.example.a_i_fitco.object.normal.level2.third.n_l2_third_cdtimer;
...
public class third2noclassification{
    ...
    @WorkerThread
    public third2noclassification(Context context, boolean isStreamMode) {
    ...
    public List<String> getPoseResult(Pose pose, Context context) {
        ...
        Intent intent = new Intent(context, n_l2_third_cdtimer.class);
