package com.example.a_i_fitco.object.overweight.level1.fifth.classification;
...
public class fifthclassifier {
    ...
    @WorkerThread
    public fifthclassifier(Context context, boolean isStreamMode) {
    ...
    public List<String> getPoseResult(Pose pose, Context context) {
        ...
        Intent intent = new Intent(context, overweight_level1_report.class);
