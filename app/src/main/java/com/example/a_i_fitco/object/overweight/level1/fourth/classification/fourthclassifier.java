package com.example.a_i_fitco.object.overweight.level1.fourth.classification;
...
public class fourthclassifier {
    ...
    @WorkerThread
    public fourthclassifier(Context context, boolean isStreamMode) {
    ...
    public List<String> getPoseResult(Pose pose, Context context) {
        ...
        Intent intent = new Intent(context, o_l1_fourth_cdtimer.class);
