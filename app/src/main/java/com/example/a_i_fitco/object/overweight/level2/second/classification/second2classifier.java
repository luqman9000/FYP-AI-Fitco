package com.example.a_i_fitco.object.overweight.level2.second.classification;
...
import com.example.a_i_fitco.object.overweight.level2.second.o_l2_second_cdtimer;
...
public class second2classifier {
    ...
    @WorkerThread
    public second2classifier(Context context, boolean isStreamMode) {
    ...
    public List<String> getPoseResult(Pose pose, Context context) {
        ...
        Intent intent = new Intent(context, o_l2_second_cdtimer.class);
