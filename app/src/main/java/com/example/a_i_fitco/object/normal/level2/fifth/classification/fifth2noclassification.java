package com.example.a_i_fitco.object.normal.level2.fifth.classification;
...
import com.example.a_i_fitco.object.underweight.level2.underweight_level2_report;
...
public class fifth2noclassification {
    ...
    @WorkerThread
    public fifth2noclassification(Context context, boolean isStreamMode) {
    ...
    public List<String> getPoseResult(Pose pose, Context context) {
        ...
        Intent intent = new Intent(context, underweight_level2_report.class);
