package com.example.a_i_fitco.object.normal.level1.fourth.classification;
...
import com.example.a_i_fitco.object.normal.level1.fourth.n_l1_fourth_cdtimer;
...
public class fourthnoclassification {
    ...
    @WorkerThread
    public fourthnoclassification(Context context, boolean isStreamMode) {
    ...
    public List<String> getPoseResult(Pose pose, Context context) {
        ...
        Intent intent = new Intent(context, n_l1_fourth_cdtimer.class);
