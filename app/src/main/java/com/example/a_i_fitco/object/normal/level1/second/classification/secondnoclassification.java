package com.example.a_i_fitco.object.normal.level1.second.classification;
...
import com.example.a_i_fitco.object.normal.level1.second.n_l1_second_cdtimer;
...
public class secondnoclassification {
    ...
    @WorkerThread
    public secondnoclassification(Context context, boolean isStreamMode) {
    ...
    public List<String> getPoseResult(Pose pose, Context context) {
        ...
        Intent intent = new Intent(context, n_l1_second_cdtimer.class);
