package com.example.a_i_fitco.object.normal.level1.first.classification;
...
public class firstnoclassification {
    ...
    @WorkerThread
    public firstnoclassification(Context context, boolean isStreamMode) {
    ...
    public List<String> getPoseResult(Pose pose, Context context) {
        Intent intent1 = new Intent(context, n_l1_first_cdtimer.class);
        intent1.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
        AlertDialog.Builder builder = new AlertDialog.Builder(context);
//
        Intent intent = new Intent(context, n_l1_first_cdtimer.class);
