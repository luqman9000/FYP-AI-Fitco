...
public class overweight_level1_report extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_overweight_level1_report);
        TextView durasi = findViewById(R.id.ovtextView5);
        TextView kalori = findViewById(R.id.ovtextView7);
        AlertDialog.Builder alert = new AlertDialog.Builder(overweight_level1_report.this);
        ...
        double calories = (getMinutew1+getMinutew2+getMinutew3+getMinutew4+getMinutew5)*(burpeesMET)*(weighto/200);
        ...
        String workout = "10x5 Jumping Jack";
        ...
        Button btn = (Button)findViewById(R.id.ovplist);
        Button btn1 = (Button)findViewById(R.id.ovl1_finish);
            ...
            public void onClick(View view){
                ...
                alert.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        startActivity(new Intent(overweight_level1_report.this, MainMenuActivity.class));
