package com.example.a_i_fitco.object.normal.level1.fifth.classification;
...
import com.example.a_i_fitco.object.normal.level1.normal_level1_report;
...
public class fifthnoclassification {
    ...
    @WorkerThread
    public fifthnoclassification(Context context, boolean isStreamMode) {
    ...
    public List<String> getPoseResult(Pose pose, Context context) {
        ...
        Intent intent = new Intent(context, normal_level1_report.class);
