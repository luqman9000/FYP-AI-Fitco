package com.example.a_i_fitco.object.overweight.level1.second.classification;
...
import com.example.a_i_fitco.object.overweight.level1.second.o_l1_second_cdtimer;
...
public class secondclassifier {//timer tmClass=new timer();
    ...
    @WorkerThread
    public secondclassifier(Context context, boolean isStreamMode) {
    ...
    public List<String> getPoseResult(Pose pose, Context context) {
        ...
        Intent intent = new Intent(context, o_l1_second_cdtimer.class);
