...
import com.example.a_i_fitco.object.psquatonly.classification.SposeClassifierProcessor;
...
public class SposeDetectorProcessor extends VisionProcessorBase<SposeDetectorProcessor.PoseWithClassification> {
    ...
    private SposeClassifierProcessor poseClassifierProcessor;
                        ...
                        task -> {
                            ...
                            if (runClassification) {
                                if (poseClassifierProcessor == null) {
                                    poseClassifierProcessor = new SposeClassifierProcessor(context, isStreamMode);
                                }
