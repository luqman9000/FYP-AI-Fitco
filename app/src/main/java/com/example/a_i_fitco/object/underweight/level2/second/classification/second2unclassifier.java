package com.example.a_i_fitco.object.underweight.level2.second.classification;
...
import com.example.a_i_fitco.object.underweight.level2.second.u_l2_second_cdtimer;
...
public class second2unclassifier {
    ...
    @WorkerThread
    public second2unclassifier(Context context, boolean isStreamMode) {
    ...
    public List<String> getPoseResult(Pose pose, Context context) {
        ...
        Intent intent = new Intent(context, u_l2_second_cdtimer.class);
