...
public class underweight_level2_report extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_underweight_level2_report);

        TextView durasi = findViewById(R.id.uv2textView5);
        TextView kalori = findViewById(R.id.uv2textView7);
        AlertDialog.Builder alert = new AlertDialog.Builder(underweight_level2_report.this);
        ...
        double calories = (((getMinutew1+getMinutew2+getMinutew3)*pushupMET)+((getMinutew4+getMinutew5)*burpeesMET))*(weighto/200);
        ...
        String workout = "10x3 Push Up & 10x2 Burpees";
        ...
        Button btn = (Button)findViewById(R.id.uv2plist);
        ...
        btn1.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                ...
                alert.setTitle("Do you want to do same exercise next time?");
                alert.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        DB.updatestatus(username_value, "4");
                        startActivity(new Intent(underweight_level2_report.this, MainMenuActivity.class));
