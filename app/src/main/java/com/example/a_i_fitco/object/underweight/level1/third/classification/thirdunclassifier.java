package com.example.a_i_fitco.object.underweight.level1.third.classification;
...
import com.example.a_i_fitco.object.underweight.level1.third.u_l1_third_cdtimer;
...
public class thirdunclassifier {
    ...
    @WorkerThread
    public thirdunclassifier(Context context, boolean isStreamMode) {
    ...
    public List<String> getPoseResult(Pose pose, Context context) {
        ...
        Intent intent = new Intent(context, u_l1_third_cdtimer.class);
