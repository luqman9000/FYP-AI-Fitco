...
public class PposeDetectorProcessor extends VisionProcessorBase<PposeDetectorProcessor.PoseWithClassification> {
    ...
    private PposeClassifierProcessor poseClassifierProcessor;
                        ...
                        task -> {
                            ...
                            if (runClassification) {
                                if (poseClassifierProcessor == null) {
                                    poseClassifierProcessor = new PposeClassifierProcessor(context, isStreamMode);
                                }
